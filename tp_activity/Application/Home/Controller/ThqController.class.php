...
class ThqController extends Controller{
    ...
    public function rock(){
        ...
        if($thqMes['opentime_start']>date('Y-m-d H:i:s',time()) || $thqMes['opentime_end']<date('Y-m-d H:i:s',time())){
