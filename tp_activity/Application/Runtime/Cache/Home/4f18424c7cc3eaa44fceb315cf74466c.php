...
<script src="/tp_activity/Public/js/jquery-1.7.2.min.js"> 
</script>
<script src="/tp_activity/Public/js/jquery.flexslider-min.js">
</script>
<script src="/tp_activity/Public/js/common.js">
</script>
<link href=/tp_activity/Public/css/memberinfo.css?v=1.2" rel="stylesheet">
<script src="/tp_activity/Public/js/index.js?v=1.1"> 
</script>
</head>
<body>
<form method="post" action="" id="form1">
    <div class="block_huo_slider">
        <div class="flexslider">
             <img style="width:100%;" src="/tp_activity/Public/images/top.png">
        </div>
    </div>
    <div>
